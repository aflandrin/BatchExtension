...
class BatchExtension extends Event {
	...
	public static function initBatch (key:String, gcm_sender_id:String = ""):Void {
		...
		if (batchextension_init_method_jni == null)
			batchextension_init_method_jni = JNI.createStaticMethod ("org.haxe.extension.BatchExtension", "initBatch", "(Ljava/lang/String;Ljava/lang/String;Lorg/haxe/lime/HaxeObject;)V");
